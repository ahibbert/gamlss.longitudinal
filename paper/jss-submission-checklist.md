...
| Private data policy | Blocking | Move LIPID/RAND to secondary status unless accepted data access instructions are supplied. |
...
| Worked example | Needs replacement | Use a reproducible primary example before any private clinical-trial example. |
