...
boot <- bootstrap_inference(fit, R = 100)
print(boot)
```
...
## Step 4: Simulation and prediction
...
If the target is a dependence-sensitive event, simulate from the fitted model:
...
## Step 5 (optional): Compare/benchmark to familiar models: gee (geepack), glmm (lme4), gam (mgcv)
...
```{r comparator}
# Fit comparison models and summarise fits
