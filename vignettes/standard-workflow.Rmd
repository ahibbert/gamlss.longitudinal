...
vignette: >
  %\VignetteIndexEntry{Standard workflow: screening, fit, inference, diagnostics, and simulation}
...
We provide a built-in check_model() function which highlights any warnings and recommendations in plain language from the fit diagnostics including convergence errors or unusual looking fit statistics.
